...
public class UpdateItemFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Update Item", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void jTableStockMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableStockMouseClicked
        ...
        txtproductId.setText(tb.getValueAt(row, 0).toString());
        txtproductName.setText(tb.getValueAt(row, 1).toString());
        txtproductCompanyName.setText(tb.getValueAt(row, 2).toString());
        ...
        String tx = tb.getValueAt(row, 6).toString()+"%";
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if(result){
            JOptionPane.showMessageDialog(null,"Product updation successfully","Success",JOptionPane.INFORMATION_MESSAGE);
            tb.setRowCount(0);
            loadProductsDetails();
            return;
        }
